...
Options:
  ...
  --rules <file>         Load blocking rules from file (.txt or .json)
  --output-dir <dir>     Output directory for JSON stats (default: ./dpi_output/)
...
Examples:
  ...
  )" << program << R"( capture.pcap filtered.pcap --rules rules.json --output-dir ./results/
...
int main(int argc, char* argv[]) {
    ...
    // Store rules file in config for hot-reload thread
    ...
    std::cout << "JSON stats written to: " << config.output_dir << "\n";
